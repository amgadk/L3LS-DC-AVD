...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | default | 192.168.0.202/24 | 192.168.0.5 |
...
| --------- | --------------- | ------------ | --------- |
| mlag1 | Vlan4094 | 10.255.252.44 | Port-Channel5 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | MLAG_dc2-leaf1_Ethernet5 | *trunk | *- | *- | *MLAG | 5 |
| Ethernet6 | MLAG_dc2-leaf1_Ethernet6 | *trunk | *- | *- | *MLAG | 5 |
...
interface Ethernet2
   ...
   mtu 1550
   no switchport
   ip address 192.168.203.95/31
!
interface Ethernet5
   description MLAG_dc2-leaf1_Ethernet5
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description MLAG_dc2-leaf1_Ethernet6
   no shutdown
   channel-group 5 mode active
```
...
interface Port-Channel5
   description MLAG_dc2-leaf1_Port-Channel5
   no shutdown
...
| 192.168.203.92 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.203.94 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 10.255.251.44 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_B | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 20 | 192.168.101.24:10020 | 10020:10020 | - | - | learned |
...
| VRF_B | 192.168.101.24:20 | connected | - |
...
router bgp 65222
   ...
   neighbor 192.168.203.92 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.92 remote-as 65002
   neighbor 192.168.203.92 description dc2-spine1_Ethernet2
   neighbor 192.168.203.94 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.94 remote-as 65002
   neighbor 192.168.203.94 description dc2-spine2_Ethernet2
   ...
   vrf VRF_A
      ...
      router-id 192.168.101.24
      neighbor 10.255.251.44 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.251.44 description dc2-leaf1_Vlan3009
      redistribute connected route-map RM-CONN-2-BGP-VRFS
   !
   vrf VRF_B
      rd 192.168.101.24:20
      route-target import evpn 20:20
      route-target export evpn 20:20
      router-id 192.168.101.24
      neighbor 10.255.251.44 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.251.44 description dc2-leaf1_Vlan3019
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
